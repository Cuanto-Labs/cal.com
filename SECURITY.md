...
Contact: [security@cuantolabs.com](mailto:security@cuantolabs.com)

Based on [https://supabase.com/.well-known/security.txt](https://supabase.com/.well-known/security.txt)

At MeetSynq, we consider the security of our systems a top priority. But no
...
- E-mail your findings to [security@cuantolabs.com](mailto:security@cuantolabs.com).
