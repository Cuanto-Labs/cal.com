...
const footer: React.ReactElement = (
  <Footer>
    <small>
      MeetSynq is the open source community edition of Cal.com. MeetSynq® and Cal®
      are a registered trademark by MeetSynq All rights reserved.
    </small>
  </Footer>
);
...
export const metadata: { title: string; description: string } = {
  title: "MeetSynq Docs",
  description: "MeetSynq self-hosting documentation",
};
