...
6. Under "Add client" give your client a name, e.g. "MeetSynq".
7. Set the Redirection URI as `<MeetSynq URL>/api/integrations/nextcloudtalk/callback` replacing MeetSynq URL with the URI at which your application runs.
8. Click "Add".
