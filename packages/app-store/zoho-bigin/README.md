...
3. Set the Redirect URL for OAuth `<MeetSynq URL>/api/integrations/zoho-bigin/callback` replacing MeetSynq URL with the URI at which your application runs.
...
7. You're good to go. Now you can easily add Zoho Bigin from the MeetSynq app store.
