...
The Booking Audit System tracks all actions and changes related to bookings in MeetSynq. The architecture is built around two core tables (`AuditActor` and `BookingAudit`) that work together to maintain a complete, immutable audit trail.
...
- **USER**: Registered MeetSynq users
...
- **WEBAPP**: MeetSynq web application
...
- **User Actor**: Registered MeetSynq user
